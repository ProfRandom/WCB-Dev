# 🗂 Master Thread Index v0.4 — Worlds by the Numbers
*Supersedes v0.3*
...
- **Staged_Terms_v0.1.md** — Pending queue of new entries since last glossary bump (currently seeded with Euclidean Algorithm).  
...
- **Memory_Reset_Protocol_v0.2.md** — Instructions for restarting threads with continuity.  
- **Master_Thread_Index_v0.4.md** — This file. The “index of indexes.”  
